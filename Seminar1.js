...
let tempC = prompt("Введите температуру в Цельсиях: ", 20);
let tempF = (9 / 5) * tempC + 32;
console.log(`Перевод в фаренгейты - ${tempF}`);
confirm(`Температура в Фаренгейтах равна ${tempF}`);
...
let name = "Rain";
let admin = name;
console.log("Пользователь зашел как админ - " + admin);
